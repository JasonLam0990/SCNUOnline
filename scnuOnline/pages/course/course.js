...
Page({
  data: {
    fakeCourses: [
      ...
      {
        id: "333",
        title: "第二章 现代远程教果然果然果然个个热狗热狗育流派",
        playUrl: 'http://ws.stream.qqmusic.qq.com/M500001VfvsJ21xFqb.mp3?guid=ffffffff82def4af4b12b3cd9337d5e7&uin=346897220&vkey=6292F51E1E384E06DCBDC9AB7C49FD713D632D313AC4858BACB8DDD29067D3C601481D36E62053BF8DFEAF74C0A5CCFADD6471160CAF3E6A&fromtag=46',
        duration: 556,
        videoUrl: 'http://wxsnsdy.tc.qq.com/105/20210/snsdyvideodownload?filekey=30280201010421301f0201690402534804102ca905ce620b1241b726bc41dcff44e00204012882540400&bizid=1023&hy=SH&fileparam=302c020101042530230204136ffd93020457e3c4ff02024ef202031e8d7f02030f42400204045a320a0201000400',
      },
  ...
  onLoad: function (options) {
    ...
    let courseTeacher = options.courseTeacher
    var that = this;
  ...
  gotoplayer: function (event) {
    var targetUrl = "nowPlay/nowPlay";
    targetUrl = targetUrl + "?name=" + event.currentTarget.dataset.name + "&playurl=" + event.currentTarget.dataset.playurl
